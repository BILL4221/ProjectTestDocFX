...
namespace Runnex.Utilities
{
    ...
    public class ShowWhenDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            //TODO: Refactor function in switch 
        ...
        private static bool CheckSameEnumType(IEnumerable<Type> checkTypes, Type classType, string fieldName)
        {
            ...
            if (fields.Length > 1)
            {
                ...
                for (int i = 1; i < fields.Length; i++)
                {
                    ...
                    {
                        currentFieldType = currentFieldType.GetElementType();

                        i += 1;
                        // The fieldNames for array will containt Array.data[0] so we need to skip two
                    }
                    else
